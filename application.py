...
# config (to be moved to separate file once it's clear how they work)
class Config(object):
    ...
    # Notethe code below provides very basic authentication (1 user-password for entire site)
...
# model section. Move this when you are comfortable about ORM 
class User(db.Model):
